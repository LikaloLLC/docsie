# 항공우주 및 방위산업 제조 분야의 프로그램 매니저와 문서 관리
...
문서화는 항공우주 및 방위산업 제조의 모든 프로젝트에서 필수적인 측면입니다. 그러나 복잡한 프로젝트 동안 발생하는 방대하고 다양한 유형의 문서를 관리하는 것은 프로그램 매니저에게 상당한 도전을 제시합니다. 주요 문제는 다음과 같습니다:
